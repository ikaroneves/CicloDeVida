package com.fiap.ikaroneves.ciclodevida.viewmodelcomlivedata
...
import com.fiap.ikaroneves.ciclodevida.R
...
class PlacarActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        placarViewModel?.placarVisitante?.observe(this, Observer { tvPlacarVisitante.text = it?.toString() })
        placarViewModel?.placarCasa?.observe(this, Observer { tvPlacarCasa.text = it?.toString() })
